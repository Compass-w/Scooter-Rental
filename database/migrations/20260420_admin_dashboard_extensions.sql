...
ALTER TABLE issue_reports ADD COLUMN IF NOT EXISTS safety_action TEXT;
ALTER TABLE issue_reports ADD COLUMN IF NOT EXISTS insurance_case_status VARCHAR(40) NOT NULL DEFAULT 'NOT_REQUIRED';
ALTER TABLE issue_reports ADD COLUMN IF NOT EXISTS customer_charge_policy TEXT;
ALTER TABLE issue_reports ADD COLUMN IF NOT EXISTS repair_charge_estimate DECIMAL(10, 2) NOT NULL DEFAULT 0;
ALTER TABLE issue_reports ADD COLUMN IF NOT EXISTS rider_injured BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE issue_reports ADD COLUMN IF NOT EXISTS third_party_involved BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE issue_reports ADD COLUMN IF NOT EXISTS emergency_services_contacted BOOLEAN NOT NULL DEFAULT FALSE;
